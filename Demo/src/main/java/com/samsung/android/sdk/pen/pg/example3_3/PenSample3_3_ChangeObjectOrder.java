...
public class PenSample3_3_ChangeObjectOrder extends Activity {
    ...
    private final SpenControlListener mControlListener = new SpenControlListener() {
        ...
        public boolean onCreated(ArrayList<SpenObjectBase> objectList, ArrayList<Rect> relativeRectList,
            ...
            if (objectList.size() == 1) {
                ...
                menu.add(new SpenContextMenuItemInfo(CONTEXT_MENU_MOVE_TO_BACKWARD_ID, "Backward", true));
                menu.add(new SpenContextMenuItemInfo(CONTEXT_MENU_MOVE_TO_FORWARD_ID, "Forward", true));
